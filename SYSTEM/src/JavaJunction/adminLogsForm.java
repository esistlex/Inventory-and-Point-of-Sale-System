...
public class adminLogsForm extends Connect {
    ...
    public void Select(){ 
        ...
        try{
            ...
            JOptionPane.showMessageDialog(adminLogsForm.this, err.getMessage());
        }
    }
    ...
    public void Select3(){     
        String [] columnNames = {"ENTRY NO.", "DATE & TIME", "NAME", "TYPE", "ACTION", "PRODUCT NAME", "QUANTITY", "PRICE", "CATEGORY"};
        tbModel.setColumnIdentifiers(columnNames);
        try{
            while(rs4.next()){
                i = rs4.getInt("ENTRY_NO");
                date = rs4.getString("DATE_AND_TIME");
                name = rs4.getString("EMP_NAME");
                type = rs4.getString("EMP_TYPE");
                action = rs4.getString("ACTION_TYPE");
                product1 = rs4.getString("PROD_NAME");
                product2 = rs4.getInt("PROD_QUANTITY");
                product3 = rs4.getDouble("PROD_PRICE");
                product4 = rs4.getString("PROD_CATEGORY");
                tb_LOGS.setVisible(true);
                tbModel.addRow(new Object [] {i,date,name,type, action, product1, product2, product3, product4,});
                x++;
                resizeColumnWidth(tb_LOGS);
            }
            rs4.close();
    ...
    private void initComponents() {
        ...
        jPanel1.add(lowinventory, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 130, 50));

        inventory.setBackground(new java.awt.Color(255, 255, 255));
        inventory.setText("<HTML><CENTER>INVENTORY HISTORY</CENTER></HTML>");
        ...
        jPanel1.add(inventory, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 130, 50));
        ...
        jPanel1.add(sales, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 130, 50));
        ...
        jPanel1.add(logs, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 130, 50));
    ...
    private void refreshBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshBtnActionPerformed
        ...
        if (logs.isEnabled() == false){
            ...
            Refresh_SALES();
            Select2();
        } else if (inventory.isEnabled() == false){
            Refresh_InventoryLog();
            Select3();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {               
                new adminLogsForm().setVisible(true);
            }
        });
    }
