...
public class adminInventoryForm extends Connect_Inventory {
    ...
    public void Select(){ 
        String [] columnNames = {"ID", "NAME", "STATUS", "AMOUNT", "CATEGORY", "PRICE"};
        ...
        try{
            ...
            JOptionPane.showMessageDialog(adminInventoryForm.this, err.getMessage());
        }
    }
    ...
    private void backBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backBtnMouseClicked
        Refresh_RS_STMT();
        adminForm adminBack2 = new adminForm();
        adminBack2.Welcome.setText(placeholder.getText());
        adminBack2.setVisible(true);
        dispose();
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try {            
            ...
            model.setRowCount(0);
            Select();
            JOptionPane.showMessageDialog(adminInventoryForm.this, "Product sucessfully added!");
            rs.close();
        } catch (SQLException err){
            JOptionPane.showMessageDialog(adminInventoryForm.this, "Error in adding product!");
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try{
            ...
            if (result == JOptionPane.YES_OPTION){                           
                ...
                statement.setString(8, product_category);
                statement.execute();
                JOptionPane.showMessageDialog(adminInventoryForm.this, "Product record has been successfully deleted!");
                Refresh_RS_STMT();
                tb_INVENTORY.revalidate();
                DefaultTableModel model = (DefaultTableModel)tb_INVENTORY.getModel();
                model.setRowCount(0);
            ...
            JOptionPane.showMessageDialog(adminInventoryForm.this, e.getMessage());
        }
        statusTxtfield.setText(null);
        productidTxtField.setText(null);
        nameTxtField.setText(null);
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        try{
            ...
            if (result == JOptionPane.YES_OPTION){
                ...
                statement.setString(8, product_category);
                statement.execute();
                JOptionPane.showMessageDialog(adminInventoryForm.this, "Product record has been successfully updated!");
                Refresh_RS_STMT();
                tb_INVENTORY.revalidate();
                DefaultTableModel model = (DefaultTableModel)tb_INVENTORY.getModel();
                model.setRowCount(0);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminInventoryForm().setVisible(true);
            }
        });
    }
