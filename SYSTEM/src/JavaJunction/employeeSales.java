...
public class employeeSales extends Connect_Inventory {
    ...
    private void searchTxtfieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTxtfieldKeyReleased
        ...
        try{
           ...
           if(rs.next()){
            ...
            JOptionPane.showMessageDialog(employeeSales.this, e.getMessage());
        }
        ...
        try {
          ...
          while (rs.next()){
              ...
              if (quantity >= product_quantity){
                JOptionPane.showMessageDialog(employeeSales.this, "Not enough stock in the inventory!");
          ...
          rs.close();
            ...
            JOptionPane.showMessageDialog(employeeSales.this, err.getMessage());
        }      
        }
    ...
    private void checkoutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkoutBtnActionPerformed
        Refresh_RS_STMT();
        String input = JOptionPane.showInputDialog(employeeSales.this, "Enter cash amount:");
        cash = Double.parseDouble(input);
        change = cash - amountdue;
        if("".equals(input)){
            JOptionPane.showMessageDialog(employeeSales.this, "Enter cash!");
        } else {
        if (cash < amountdue){
            JOptionPane.showMessageDialog(employeeSales.this, "Insufficient cash!");
        }
        ...
        try {       
            ...
            JOptionPane.showMessageDialog(employeeSales.this, "Success!\nYour change is: "+change);
    ...
    private void removeCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeCartActionPerformed
        ...
        itemQuantityTxtfield.setText(null);
        priceTxtfield.setText(null);
        JOptionPane.showMessageDialog(employeeSales.this, "Item removed.");
