...
public class managerEmployeeForm extends Connect {
    ...
    public managerEmployeeForm() {       
        ...
        if (typeField.getSelectedItem() == "ADMIN") {
    ...
    void Get_Set_Records(){
        try{
            ...
            JOptionPane.showMessageDialog(managerEmployeeForm.this, err.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 450));
        ...
        typeField.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                typeFieldItemStateChanged(evt);
            }
        });
        ...
        MainPanel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, 150, 450));
    ...
    private void backBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backBtnMouseClicked
        Refresh_RS_STMT();
        managerForm managerBack1 = new managerForm();
        managerBack1.Welcome.setText(placeholder.getText());
        managerBack1.setVisible(true);
        dispose();        
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try{
            ...
            if (result == JOptionPane.YES_OPTION){                           
                ...
                JOptionPane.showMessageDialog(managerEmployeeForm.this, "Employee has been successfully deleted!");
                Refresh_RS_STMT();
            ...
            JOptionPane.showMessageDialog(managerEmployeeForm.this, e.getMessage());
        }
        employeeidTxtField.setText(null);
        nameTxtField.setText(null);
        passwordTxtField.setText(null);
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        try{
            ...
            if (result == JOptionPane.YES_OPTION){
                ...
                showAll();
                stmt.executeUpdate(sql);
                JOptionPane.showMessageDialog(managerEmployeeForm.this, "Employee has been successfully updated!");
                Refresh_RS_STMT();
                tb_EMPLOYEES.revalidate();
                DefaultTableModel model = (DefaultTableModel)tb_EMPLOYEES.getModel();
                model.setRowCount(0);
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        try {            
            ...
            model.setRowCount(0);
            Select();
            JOptionPane.showMessageDialog(managerEmployeeForm.this, "Employee sucessfully added!");
            rs.close();
        } catch (SQLException err){
            JOptionPane.showMessageDialog(managerEmployeeForm.this, "Employee unsucessfully added!");
    ...
    private void typeFieldItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_typeFieldItemStateChanged
        if (typeField.getSelectedItem() != "ADMIN") {
        ...
        } else if (typeField.getSelectedItem() == "ADMIN") {
            addBtn.setEnabled(false);
            editBtn.setEnabled(false);
            deleteBtn.setEnabled(false);
            typeField.setEnabled(false);
        }
    }//GEN-LAST:event_typeFieldItemStateChanged
    
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {               
                new managerEmployeeForm().setVisible(true);
            }
        });
    }
