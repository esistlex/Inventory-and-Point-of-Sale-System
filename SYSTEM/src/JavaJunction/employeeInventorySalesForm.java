...
public class employeeInventorySalesForm extends Connect_Inventory {
    DefaultTableModel tbModel = new DefaultTableModel();
    int x = 0;
 
    public employeeInventorySalesForm() {       
        initComponents();
    ...
    public void Select(){ 
        ...
        try{
            ...
            JOptionPane.showMessageDialog(employeeInventorySalesForm.this, err.getMessage());
        }
    }
    ...
    private void searchTxtFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTxtFieldKeyReleased
        ...
        if ("".equals(search)){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(employeeInventorySalesForm.this, e.getMessage());
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employeeInventorySalesForm().setVisible(true);
            }
        });
    }
